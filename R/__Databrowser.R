...
source("__DATABROWSER_PATH__/R/trigFunctionsPlot.R")
source("__DATABROWSER_PATH__/R/mapPlot.R")
...
__DATABROWSER__ <- function(jsonArgs='{}') {
  ...
  if (infoList$plotType == 'TrigFunctions') {
    
    returnValues <- trigFunctionsPlot(dataList,infoList,textList)
